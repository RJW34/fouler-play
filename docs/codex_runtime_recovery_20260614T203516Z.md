...
- Repo-side fix status: **GO**. The JIGGLYPUFF emergency fallback bug was fixed and validated.
...
1. Improve replay/trace linking so autoresearch can tie recent losses to request-backed legal-option traces.
