...
def init_logging(level, log_to_file):
    ...
    # (e.g. Ã¢Ëœâ€  in player names). StreamHandler.emit() calls stream.write() directly,
...
class _FoulPlayConfig:
    ...
    def configure(self):
        ...
        parser.add_argument(
            ...
            help="If > 0, force-decide any battle reaching this turn by "
            "forfeiting the lower-HP-fraction side (score-on-cap). 0 disables.",
        )
        parser.add_argument(
            "--team-name",
            default=None,
        ...
        self.battle_turn_cap = getattr(args, "battle_turn_cap", 0)
